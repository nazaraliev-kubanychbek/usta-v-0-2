  ...
  return (
    <div>
        ...
        <div className='Services-imgs'>
            <img className='Services-img' src={imgs1} alt="Услуга 1" />
                  <div className='text'>
                      ...
                      <p className='Services-title'>Lorem ipsum dolor sit amet consectetur. Sed porttitor amet aenean enim. Praesent turpis odio rutrum platea egestas duis turpis nunc. Non vitae ac risus molestie tristique molestie enim volutpat. Vehicula iaculis sem velit accumsan velit.</p>
                  </div>
        </div>
      ...
      <div className='lol'>
        ...
        <div className='class'>
          <h3 className='lol-text'>Стажировки и практические программах для студентов и молодых специалистов</h3>
